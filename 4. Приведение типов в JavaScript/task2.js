...
console.log(Number('50'), typeof Number('50')); //теперь явное
//2
console.log(Number('100'), typeof Number('100')); // явное
//3
console.log(('' + 1), typeof ('' + 1)); // неявное
console.log(String(1), typeof String(1)); // теперь явное
//4
...
console.log(Number('001'), typeof Number('001')); // теперь явное
//7
console.log((1 + ''), typeof(1 + ''));  // неявное
console.log(String(1), typeof String(1)); // теперь явное
//8
