  ...
  tasksListContainer.addEventListener('click', (event) => {
    ...
    if(isDeleteButton){
        ...
        if(modalOverlay){
            ...
            tasksListContainer.append(Notification);
        }
        ...
        const deleteButton = document.querySelector('.delete-modal__confirm-button'); //удаление элемента
        deleteButton.addEventListener('click', () => {
            const buttonId = buttonName.dataset.taskId;
            const index = tasks.findIndex(element => element.id === buttonId);
